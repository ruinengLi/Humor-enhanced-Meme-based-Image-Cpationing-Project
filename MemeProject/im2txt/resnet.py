# -*- coding: utf-8 -*-
"""
Created on Mon Dec 30 20:53:14 2019
...
class ResNet(object):
    def __init__(self, hp, images, global_step, name=None, reuse_weights=False):
    ...
    def build_tower(self, images):
        ...
        with tf.variable_scope('logits') as scope:
            ...
            flattened = tf.reshape(x, [-1, 6*6*256])
            x = self._fc(x, self._hp.num_classes,flattened)
    ...
    def _fc(self, x, out_dim,flattened, input_q=None, output_q=None, name="fc"):
        b, in_dim = x.get_shape().as_list()
        x = fc(flattened, 6*6*256, 4096, name='fc')
